...
export const slidesData = [
  ...
  },
  {
    ...
    leftSection: {
      id: "03",
      title: "Project Planning & Strategy Development",
      buttons: ["Resource Allocation", "Simulation Roadmap"],
      image: images.home.CH3,
    },
    rightSection: {
      id: "04",
      title: "Simulation Process Execution",
      buttons: [
        "CAD Model Prepation and Mesh Generation",
        "Boundary Conditions, Calculations, and Result Analysis",
      ],
  ...
  },
  {
    ...
    leftSection: {
      ...
      buttons: ["Verification Protocols", "Validation Testing"],
      image: images.home.CH5,
    },
    rightSection: {
      id: "06",
      title: "Reporting And Delivery",
      buttons: ["Comprehensive Reporting", "Final Delivery"],
